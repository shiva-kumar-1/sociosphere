...
export default function About({ navigate }: { navigate: (path: string) => void }) {
    ...
    return (
        <div className={`min-h-screen transition-colors duration-300 ${isDark ? "bg-cyber-dark text-white" : "bg-white text-gray-900"}`}>
            <Header navigate={navigate} currentPath="/about" />
            ...
            <div className="px-6 py-16">
                ...
                >
                    ...
                    <p className={`mt-6 text-lg leading-relaxed max-w-3xl mx-auto ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                ...
                <motion.div
                    ...
                    className={`max-w-6xl mx-auto p-10 rounded-3xl mb-20 border transition-colors
                        ${isDark ? "glass-card border-cyber-border" : "glass-card-light border-gray-200"}`}
                >
